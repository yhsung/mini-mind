...
Execute task 14 for the mindmap specification.

## Task Description
Add persistence manager in rust_core/src/persistence/manager.rs
...
Execute with @spec-task-executor agent the following task: "Add persistence manager in rust_core/src/persistence/manager.rs"

```
Use the @spec-task-executor agent to implement task 14: "Add persistence manager in rust_core/src/persistence/manager.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Add persistence manager in rust_core/src/persistence/manager.rs
- Leverage: rust
- Requirements: REQ-MM-007

## Instructions
- Implement ONLY task 14: "Add persistence manager in rust_core/src/persistence/manager.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 14 --mode complete
```
