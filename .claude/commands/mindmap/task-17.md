...
Execute task 17 for the mindmap specification.

## Task Description
Implement FFI node operations in rust_core/src/ffi/node_ops.rs
...
Execute with @spec-task-executor agent the following task: "Implement FFI node operations in rust_core/src/ffi/node_ops.rs"

```
Use the @spec-task-executor agent to implement task 17: "Implement FFI node operations in rust_core/src/ffi/node_ops.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Implement FFI node operations in rust_core/src/ffi/node_ops.rs
- Leverage: rust
- Requirements: REQ-MM-001

## Instructions
- Implement ONLY task 17: "Implement FFI node operations in rust_core/src/ffi/node_ops.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 17 --mode complete
```
