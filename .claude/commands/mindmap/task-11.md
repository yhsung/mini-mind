...
Execute task 11 for the mindmap specification.

## Task Description
Implement force-directed layout in rust_core/src/layout/force.rs
...
Execute with @spec-task-executor agent the following task: "Implement force-directed layout in rust_core/src/layout/force.rs"

```
Use the @spec-task-executor agent to implement task 11: "Implement force-directed layout in rust_core/src/layout/force.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Implement force-directed layout in rust_core/src/layout/force.rs
- Leverage: rust
- Requirements: REQ-MM-002

## Instructions
- Implement ONLY task 11: "Implement force-directed layout in rust_core/src/layout/force.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 11 --mode complete
```
