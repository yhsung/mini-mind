...
Execute task 7 for the mindmap specification.

## Task Description
Add graph operations in rust_core/src/graph/operations.rs
...
Execute with @spec-task-executor agent the following task: "Add graph operations in rust_core/src/graph/operations.rs"

```
Use the @spec-task-executor agent to implement task 7: "Add graph operations in rust_core/src/graph/operations.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Add graph operations in rust_core/src/graph/operations.rs
- Leverage: rust
- Requirements: REQ-MM-001, REQ-MM-003

## Instructions
- Implement ONLY task 7: "Add graph operations in rust_core/src/graph/operations.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 7 --mode complete
```
