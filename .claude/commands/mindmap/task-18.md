...
Execute task 18 for the mindmap specification.

## Task Description
Add FFI layout operations in rust_core/src/ffi/layout_ops.rs

## Code Reuse
**Leverage existing code**: rust

## Requirements Reference
**Requirements**: REQ-MM-002, REQ-MM-003
...
Execute with @spec-task-executor agent the following task: "Add FFI layout operations in rust_core/src/ffi/layout_ops.rs"

```
Use the @spec-task-executor agent to implement task 18: "Add FFI layout operations in rust_core/src/ffi/layout_ops.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Add FFI layout operations in rust_core/src/ffi/layout_ops.rs
- Leverage: rust
- Requirements: REQ-MM-002, REQ-MM-003

## Instructions
- Implement ONLY task 18: "Add FFI layout operations in rust_core/src/ffi/layout_ops.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 18 --mode complete
```
