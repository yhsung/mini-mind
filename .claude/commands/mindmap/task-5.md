...
Execute task 5 for the mindmap specification.

## Task Description
Create Position type in rust_core/src/types/position.rs
...
Execute with @spec-task-executor agent the following task: "Create Position type in rust_core/src/types/position.rs"

```
Use the @spec-task-executor agent to implement task 5: "Create Position type in rust_core/src/types/position.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Create Position type in rust_core/src/types/position.rs
- Requirements: REQ-MM-003

## Instructions
- Implement ONLY task 5: "Create Position type in rust_core/src/types/position.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 5 --mode complete
```
