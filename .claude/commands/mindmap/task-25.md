...
Execute task 25 for the mindmap specification.

## Task Description
Create base mindmap canvas in flutter_app/lib/widgets/mindmap_canvas.dart

## Code Reuse
**Leverage existing code**: flutter

## Requirements Reference
**Requirements**: REQ-MM-001, REQ-MM-003
...
Execute with @spec-task-executor agent the following task: "Create base mindmap canvas in flutter_app/lib/widgets/mindmap_canvas.dart"

```
Use the @spec-task-executor agent to implement task 25: "Create base mindmap canvas in flutter_app/lib/widgets/mindmap_canvas.dart" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create base mindmap canvas in flutter_app/lib/widgets/mindmap_canvas.dart
- Leverage: flutter
- Requirements: REQ-MM-001, REQ-MM-003

## Instructions
- Implement ONLY task 25: "Create base mindmap canvas in flutter_app/lib/widgets/mindmap_canvas.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 25 --mode complete
```
