...
Execute task 26 for the mindmap specification.

## Task Description
Implement node widget in flutter_app/lib/widgets/node_widget.dart
...
Execute with @spec-task-executor agent the following task: "Implement node widget in flutter_app/lib/widgets/node_widget.dart"

```
Use the @spec-task-executor agent to implement task 26: "Implement node widget in flutter_app/lib/widgets/node_widget.dart" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Implement node widget in flutter_app/lib/widgets/node_widget.dart
- Leverage: flutter
- Requirements: REQ-MM-001

## Instructions
- Implement ONLY task 26: "Implement node widget in flutter_app/lib/widgets/node_widget.dart"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 26 --mode complete
```
