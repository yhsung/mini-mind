...
Execute task 20 for the mindmap specification.

## Task Description
Create FFI file operations in rust_core/src/ffi/file_ops.rs

## Code Reuse
**Leverage existing code**: rust

## Requirements Reference
**Requirements**: REQ-MM-005, REQ-MM-007
...
Execute with @spec-task-executor agent the following task: "Create FFI file operations in rust_core/src/ffi/file_ops.rs"

```
Use the @spec-task-executor agent to implement task 20: "Create FFI file operations in rust_core/src/ffi/file_ops.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create FFI file operations in rust_core/src/ffi/file_ops.rs
- Leverage: rust
- Requirements: REQ-MM-005, REQ-MM-007

## Instructions
- Implement ONLY task 20: "Create FFI file operations in rust_core/src/ffi/file_ops.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 20 --mode complete
```
