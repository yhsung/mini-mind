...
Execute task 4 for the mindmap specification.

## Task Description
Create ID wrapper types in rust_core/src/types/ids.rs
...
Execute with @spec-task-executor agent the following task: "Create ID wrapper types in rust_core/src/types/ids.rs"

```
Use the @spec-task-executor agent to implement task 4: "Create ID wrapper types in rust_core/src/types/ids.rs" for the mindmap specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Create ID wrapper types in rust_core/src/types/ids.rs
- Requirements: REQ-MM-001

## Instructions
- Implement ONLY task 4: "Create ID wrapper types in rust_core/src/types/ids.rs"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks mindmap 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks mindmap 4 --mode complete
```
